...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="998" height="424">
	<tr>
		...
		<div style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; color:#FFF; text-align:justify; width:600px">
            <form action="gravar.asp" method="post" id="formulario" name="formulario">
            ...
            <script language="javascript">
              ...
              <table cellpadding="2" cellspacing="2" style="font-family:Tahoma, Geneva, sans-serif; font-size:12px; text-align:justify;">
                ...
                <tr>
                	<td width="40" align="center"><input type="radio" id="tipo" name="tipo" value="boleto" checked="checked"></td>
                    <td width="70" align="center"><img src="http://www.seremcena.org.br/shopline/boleto_bancario.gif"></td>
                ...
                <tr>
                	<td width="40" align="center"><input type="radio" id="tipo" name="tipo" value="debito"></td>
                    <td width="70" align="center"><img src="http://www.seremcena.org.br/shopline/financiamento.gif"></td>
                	<td width="440" style="padding:10px;">
