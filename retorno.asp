	...
	<body lang="en">
						...
						<li><a href="#">Fotos e Vídeos</span></a>
							<ul>
								<li>
									<a href="#">Fotos</a>
									<ul>
										<li><a href="fotos-campanhas-ser-em-cena.html">Campanhas</a></li>
		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- masthead -->
		        <div id="masthead">
					<span class="head">Doações</span><span class="subhead">Faça sua Doação</span>
	        	...
	        	<div id="page-content-full">
					...
					<p><h3>Agradecimento</h3></p>

					<p>
						A Ser em Cena agradece imensamente pela sua sensibilização e contribuição realizada em nosso site. Sua doação permite a continuidade das nossas atividades no atendimento gratuito para auxílio a reabilitação de pessoas portadoras de afasia e sua reinserção à vida comunitária.
					</p>

					<p>
						Esperamos contar sempre com o seu apoio! Sua doação é muito importante para nós!
					</p>
		...
		<footer>
			<div class="wrapper">			
				<ul id="footer-cols">					
					...
					<li class="third-col">						
						<img src="img/rodape/logos-rodape.png" />						
					</li>	
				</ul>				
				<div class="clearfix"></div>
